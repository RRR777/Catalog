    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-2 pull-right">
                <form action="{{ URL::to('/searchrole') }}" method="get" role="search">
                    {{ csrf_field() }}
...
<table class="table table-bordered table-striped table-hover table-responsive" id="roles-table">
    <thead>
        <tr>
...
<div class="row">
    <div class="col-sm-3">
        <br>
        <span>Total records found: {{ $roles->total() }}</span>
    </div>

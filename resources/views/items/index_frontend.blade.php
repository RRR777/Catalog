                                    ...
                                    <div class="product-shoe-info shoe">
                                        <div class="men-pro-item">
                                            <div class="men-thumb-item">
                                                <img src="{{ asset('images/items/' . $item->id . '/' . $item->image) }}" alt="">
                                                <div class="men-cart-pro">
                                                    <div class="inner-men-cart-pro">
                                                        <a href="{{ route('items.show', [$item->id]) }}" class="link-product-add-cart">Quick View</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="info-product-price">
                                                    ...
                                                    <div class="shoe single-item hvr-outline-out">
                                                        <form action="#" method="post">
                                                            ...
                                                            <input type="hidden" name="shoe_item" value="{{ $item->name . "(sku: " . $item->sku . ") " }}">
                                                            @if($item->specialPrice)
                                                                <input type="hidden" name="amount" value="{{ $item->specialPrice }}">
                                                            @else
